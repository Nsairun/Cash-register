...
function handleBillAmountSubmit (e) {
  ...
  if (billAmountValue === '' || billAmountValue === null) {
    displayErrorMessage(true, 'INSUFFICIENT_FUNDS', sectionBillAmount)
...
function handleCashSubmit(e) {
  ...
  if (
    ...
    displayErrorMessage(
      true,
      'Please enter valid bill and cash amount to continue',
    ...
    displayErrorMessage(
      true,
      'Please enter a valid bill and cash amount to continue',
      sectionCashAmountInput
    )
    ...
    if (cash < bill) {
      ...
      displayErrorMessage(true, 'CLOSED', sectionCashAmountInput)
    } else if (cash === bill) {
